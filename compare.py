...
p1 = 'out/vanilla/fees/' + pf
p2 = 'out/vanilla/no_fees/' + pf
p3 = 'out/crash_resistant/fees/' + pf
p4 = 'out/crash_resistant/no_fees/' + pf
...
# Test significance
p1_values = ttest(vanilla_no_fee, out_path = 'out/vanilla/no_fees/density')
p2_values = ttest(vanilla_fee, out_path = 'out/vanilla/fees/density')
p3_values = ttest(crash_resistant_fee, out_path = 'out/crash_resistant/fees/density')
